...
const About = () => {
  ...
  const profileImages = [
    { src: profile1, caption: "Passionate about data, design, and development." },
    { src: profile2, caption: "Always learning, always building." },
    { src: profile3, caption: "Curious, detail-oriented, and passionate about building digital experiences." }
  ];
          ...
          <div className="flex flex-col md:flex-row justify-between items-start max-w-6xl mx-auto gap-8">
            <div className="text-left w-full md:w-auto">
              <div className="ascii-container justify-start text-3xl md:text-4xl lg:text-5xl">
                <AsciiMorphText text="Hi, I'm Jamie Dabao" />
              </div>
