        ...
        features={[
          {
            ...
            description: "Browse and purchase products through an intuitive interface.",
          },
          {
            icon: Smartphone,
            title: "Mobile Friendly",
            description: "Designed for a smooth mobile shopping experience.",
          },
          {
            icon: Palette,
            title: "Modern UI",
            description: "Clean and user-friendly interface designed in Figma.",
          },
          {
            icon: Database,
            title: "Product Management",
            description: "Organized product listings and categories.",
          },
        ]}
      />
